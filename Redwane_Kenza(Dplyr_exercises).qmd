...
```{r}
credit_default_repayment <- credit_payment |> select(ID,,matches("PAY_[0-9]"))
...
```{r}
credit_default_bill <- credit_payment |> select(ID,,matches("BILL_AMT[0-9]"))
...
credit_default_payment <- credit_payment |> select(ID,,matches("PAY_AMT[0-9]"))
```
